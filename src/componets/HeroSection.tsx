        ...
        <div className={styles.grid}>
          ...
          <div className={styles.leftContent}>
            ...
            <p className={styles.subtext}>
              Domine listas, pilhas, filas, árvores e muito mais com exemplos claros e interativos.
Do básico ao avançado, transforme conceitos complexos em habilidades sólidas para resolver problemas de programação no dia a dia.
            </p>
          ...
          <div className={styles.rightImageSection}>
            ...
            <div className={styles.backgroundElements}>
              ...
              {/* Flowing lines */}
              <svg className={styles.flowingSvg} viewBox="0 0 400 400" fill="none">
                <path
